...
import io.mosip.resident.dto.IdTypeEnum;
import io.mosip.resident.util.EnvUtil;
...
public abstract class IdAuthConfig extends HibernateDaoConfig {
	...
	private static final Logger logger = LoggerConfiguration.logConfig(IdAuthConfig.class);
	...
	public void initialize() {
		IdTypeEnum.initializeAliases(environment.getEnvironment());
	}
